...
(function() {
	tinymce.create('tinymce.plugins.MoreTagPlugin', {
		init : function(ed, url) {
			var pb = '<img src="' + ed.theme.url + '/img/trans.gif" class="mceMoreTag mceItemNoResize" />', cls = 'mceMoreTag', sep = ed.getParam('moretag_separator', '<!--MORE-->'), pbRE;
			...
			// Register buttons
			ed.addButton('moretag', {title : 'add "MORE..." tag', cmd : "mceMoreTag",image:url+"/img/moretag.png"});
